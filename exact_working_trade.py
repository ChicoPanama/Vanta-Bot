...
async def test_exact_working_trade():
    ...
    print('   Working trade: 0xfb8ae4e783b4d0b0a02f2afcd670f6719b5c56f7a9d20e482e1399f16c64917c')
    print('=' * 60)
    ...
    try:
        ...
        print(f'   Transaction: 0xfb8ae4e783b4d0b0a02f2afcd670f6719b5c56f7a9d20e482e1399f16c64917c')
        print(f'   Pair Index: 0 (ETH/USD)')
        print(f'   Leveraged Position Size: 167,602,500')
        print(f'   Value Long: 984,771,788')
        print(f'   Value Short: 893,899,680')
        print(f'   Price: 25,408,948,094,745')
        ...
        try:
            ...
            print(f'   ✅ TradeInput created with EXACT working parameters:')
            ...
            try:
                ...
                print(f'   ✅ TradeInput created with Value Long: 984,771,788')
                ...
                print(f'   ✅ Value Long transaction built successfully!')
                
                tx_hash_high = await trader.send_and_get_transaction_hash(trade_tx_high)
                print(f'   ✅ Value Long trade executed successfully!')
                ...
                print(f'   → Still need to find exact parameter format')
