...
class LeaderboardService:
    ...
    async def _get_mock_leaderboard(self, limit: int) -> List[Dict[str, Any]]:
        ...
        for i, addr in enumerate(mock_addresses[:limit]):
            traders.append({
                ...
                "archetype": ["High Frequency Trader", "Active Trader", "Whale", "Retail Trader", "Occasional Trader"][i % 5],
    ...
    async def _compute_trader_stats_from_db(self, address: str) -> Optional[Dict[str, Any]]:
