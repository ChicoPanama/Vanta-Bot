...
class ExecutionModeManager:
    ...
    def __init__(self, redis_client=None):
        ...
        if self.redis is None:
            try:
                ...
                logger.warning(f"Redis connection failed: {e}. Using in-memory mode only.")
                self.redis = None
    ...
    def _load_from_redis(self) -> None:
        ...
        try:
            ...
            if mode_data:
                ...
                logger.info("Loaded execution mode from Redis: {} (emergency: {})", 
                           self._mode.value, self._emergency_stop)
        except Exception as e:
    ...
    def refresh_from_redis(self) -> None:
        ...
        try:
            self._load_from_redis()
            logger.debug("Refreshed execution mode from Redis: {} (emergency: {})", 
                       self._mode.value, self._emergency_stop)
        except Exception as e:
