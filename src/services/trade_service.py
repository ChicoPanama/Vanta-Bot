...
from ..core.models import (
    HumanTradeParams, TradeInput, TradeResult, TradeLimits, 
    ContractStatus, WalletInfo, RiskLimits
)
...
class TradeService:
    ...
    def __init__(
        ...
        logger.info(f"  Trading Contract: {self.network_config['contracts']['trading']['address']}")
    ...
    def _validate_network_config(self) -> None:
        ...
        for contract in required_contracts:
            if contract not in contracts:
                raise ValueError(f"Missing required contract in network config: {contract}")
