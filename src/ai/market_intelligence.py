...
class MarketIntelligence:
    ...
    async def _update_regime_analysis(self, symbol: str, price_data: PriceData):
        ...
        try:
            ...
            self.regime_data[symbol]['prices'] = [
                p for p in self.regime_data[symbol]['prices'] 
    ...
    async def _calculate_regime_metrics(self, symbol: str):
        ...
        try:
            ...
            logger.debug(f"{symbol}: Regime={regime}, Vol={volatility:.3f}, Trend={trend}")
    ...
    async def _analyze_overall_regime(self):
        ...
        while self.is_running:
            try:
                ...
                for symbol, data in self.regime_data.items():
    ...
    def _determine_overall_sentiment(self, green_count: int, yellow_count: int, red_count: int) -> str:
