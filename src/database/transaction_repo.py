...
class TransactionRepository:
    ...
    async def record_if_new(
        self, request_id: str, tx_hash: str, payload_hash: str
    ) -> bool:
        ...
        try:
            ...
            transaction = Transaction(
                request_id=request_id, tx_hash=tx_hash, payload_hash=payload_hash
            )
            ...
            logger.warning(
                f"Transaction already exists (integrity error): {request_id}"
            )
