...
async def cmd_prefs(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    rows = [
        ...
        [
            ("Leverage chips 5/10/25/50", "pf:lev:5,10,25,50"),
            ("10/25/50/100", "pf:lev:10,25,50,100"),
        ],
        [
            ("Collateral 50/100/250/500", "pf:col:50,100,250,500"),
            ("100/250/500/1000", "pf:col:100,250,500,1000"),
        ],
        [
            ("Favorites ETH,BTC", "pf:fav:ETH/USD,BTC/USD"),
            ("+SOL", "pf:fav:ETH/USD,BTC/USD,SOL/USD"),
        ],
        [("Default pair ETH/USD", "pf:pair:ETH/USD"), ("BTC/USD", "pf:pair:BTC/USD")],
        [("Mode pref DRY", "pf:mode:DRY"), ("LIVE (UI only)", "pf:mode:LIVE")],
    ]
    await update.effective_chat.send_message(
        _prefs_text(p), parse_mode="Markdown", reply_markup=kb(rows)
    )
