...
def get_position_action_keyboard(position_id: int):
    keyboard = [
        [InlineKeyboardButton("📊 Details", callback_data=f"pos_details_{position_id}"),
        ...
        [InlineKeyboardButton("📈 Add Size", callback_data=f"pos_add_{position_id}"),
         InlineKeyboardButton("🛡️ Set SL/TP", callback_data=f"pos_sltp_{position_id}")],
...
def get_user_type_keyboard():
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("ℹ️ What's the difference?", callback_data="user_type_info")]
    ]
    return InlineKeyboardMarkup(keyboard)
...
def get_user_type_info_keyboard():
    ...
    keyboard = [
        [InlineKeyboardButton("🟢 Choose Simple", callback_data="user_type_simple"),
         InlineKeyboardButton("🔴 Choose Advanced", callback_data="user_type_advanced")],
...
def get_tp_sl_keyboard(position_id: int):
    ...
    keyboard = [
        [InlineKeyboardButton("🎯 Set Take Profit", callback_data=f"set_tp_{position_id}"),
         InlineKeyboardButton("🛡️ Set Stop Loss", callback_data=f"set_sl_{position_id}")],
        [InlineKeyboardButton("🔄 Update Both", callback_data=f"update_tp_sl_{position_id}"),
