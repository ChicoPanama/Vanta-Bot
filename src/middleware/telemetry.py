...
class TelemetryMiddleware:
        ...
        def decorator(func: Callable) -> Callable:
            ...
            async def wrapper(
                ...
                try:
                    ...
                    logger.error(
                        f"Command failed with AppError: {command}",
                        extra={
                            "user_id_hash": hash(str(user_id))
                            if track_user and user_id
                            else None,
                    ...
                    logger.error(
                        f"Command failed with unexpected error: {command}",
                        extra={
                            "user_id_hash": hash(str(user_id))
                            if track_user and user_id
                            else None,
    ...
    def track_trade_execution(
        self, track_user: bool = True, track_performance: bool = True
    ):
        ...
        def decorator(func: Callable) -> Callable:
            ...
            async def wrapper(*args, **kwargs) -> Any:
                ...
                try:
                    ...
                    success = False
                    logger.error(
                        f"Trade execution failed: {pair} {side}",
                        extra={
                            "user_id_hash": hash(str(user_id))
                            if track_user and user_id
                            else None,
    ...
    def track_copy_trade(self, track_user: bool = True, track_performance: bool = True):
        ...
        def decorator(func: Callable) -> Callable:
            ...
            async def wrapper(*args, **kwargs) -> Any:
                ...
                try:
                    ...
                    reason = str(e)
                    logger.error(
                        f"Copy trade execution failed: {leader_address} -> {follower_id}",
                        extra={
    ...
    def track_performance(self, operation_name: str, track_user: bool = False):
