...
from ..core.models import TradeInput, ContractStatus, TradeResult, WalletInfo
from ..core.math import TradeUnits
...
class Web3TradingAdapter:
    ...
    def __init__(self, rpc_url: str, private_key: str, trading_address: str):
        ...
        logger.info(f"Web3 Trading Adapter initialized")
