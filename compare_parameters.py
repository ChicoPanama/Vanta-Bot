...
async def compare_parameters():
    ...
    try:
        ...
        print(f'   Leveraged Position Size: 167,602,500 (≈ $167.60)')
        ...
        try:
            ...
            print(f'   ✅ TradeInput created with working parameters:')
            ...
            try:
                ...
                print(f'   ✅ TradeInput created with $200 collateral')
                ...
                print(f'   ✅ $200 transaction built successfully!')
                
                tx_hash_high = await trader.send_and_get_transaction_hash(trade_tx_high)
                print(f'   ✅ $200 trade executed successfully!')
