...
def test_all_fixes():
    ...
    try:
        from src.bot.keyboards.trading_keyboards import (
            get_user_type_keyboard, get_simple_trading_keyboard, 
            get_advanced_trading_keyboard, get_advanced_orders_keyboard,
            get_position_management_keyboard, get_risk_management_keyboard,
            get_analytics_keyboard, get_market_data_keyboard,
            get_alerts_keyboard, get_advanced_settings_keyboard
        )
