...
from src.services.copytrading.alerts import (
    send_daily_digest, fanout_trader_signal, on_trader_signal, _recent_notifications
)
...
@pytest.mark.asyncio
async def test_on_trader_signal_with_notification(mock_bot, mock_copy_service, clear_notifications):
...
@pytest.mark.asyncio
async def test_on_trader_signal_server_dry_notification(mock_bot, mock_copy_service, clear_notifications):
...
@pytest.mark.asyncio
async def test_on_trader_signal_executor_missing_notification(mock_bot, mock_copy_service, clear_notifications):
    ...
    mock_copy_service.maybe_autocopy_on_signal.return_value = (False, "executor_missing")
...
@pytest.mark.asyncio
async def test_notification_dedupe_expires(mock_bot, mock_copy_service, clear_notifications):
...
@pytest.mark.asyncio
async def test_different_failure_reasons(mock_bot, mock_copy_service, clear_notifications):
