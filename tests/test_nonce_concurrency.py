...
class TestNonceReservationConcurrency:
    ...
    async def test_redis_failure_fallback(self, hybrid_manager):
        ...
        with patch.object(hybrid_manager.store, 'redis_store') as mock_redis:
            ...
            async with hybrid_manager.reserve('0x3333333333333333333333333333333333333333') as nonce:
    ...
    async def test_reservation_timeout_handling(self, in_memory_manager):
        ...
        with patch.object(in_memory_manager.store, 'reserve') as mock_reserve:
            ...
            with pytest.raises(RuntimeError):
                async with in_memory_manager.reserve('0x1111111111111111111111111111111111111111') as nonce:
                    pass
    ...
    async def test_reservation_context_manager(self, in_memory_manager):
        ...
        # Test normal usage
        async with in_memory_manager.reserve('0x1111111111111111111111111111111111111111') as nonce1:
            assert nonce1 > 0
        
        # Test nested reservations
        async with in_memory_manager.reserve('0x1111111111111111111111111111111111111111') as nonce2:
            assert nonce2 > nonce1
        
        # Test multiple sequential reservations
        async with in_memory_manager.reserve('0x1111111111111111111111111111111111111111') as nonce3:
