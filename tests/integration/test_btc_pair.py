...
async def test_btc_pair():
    ...
    try:
        ...
        try:
            ...
            print("   ✅ TradeInput created with BTC pair")
            ...
            print("   Position size: $10,000,000")
            ...
            print("   🎉 SUCCESS! BTC trade executed!")
            print(f"   📝 Transaction Hash: {tx_hash}")
            print(f"   🔗 View on BaseScan: https://basescan.org/tx/{tx_hash}")

            print("\n🎉 BTC PAIR WORKS!")
            print("✅ BTC pair (pair 1) works with large position")
            print("✅ Bot now works!")
            ...
            if "BELOW_MIN_POS" in str(trade_error):
                print("   ❌ BTC pair also too small: BELOW_MIN_POS")
            else:
            ...
            try:
                ...
                print(
                    "   ✅ TradeInput created with $1,000,000 collateral, 1000x leverage"
                )
                print("   Position size: $1,000,000,000 (1 billion)")
                ...
                print("   ✅ $1B transaction built successfully!")

                tx_hash_huge = await trader.send_and_get_transaction_hash(trade_tx_huge)
                print("   🎉 SUCCESS! $1B trade executed!")
                ...
                print("   → There is something fundamentally wrong with the parameters")
