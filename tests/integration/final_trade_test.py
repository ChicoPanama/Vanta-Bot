#!/usr/bin/env python3
"""
Final trade test using the Avantis SDK build_trade_open_tx method
"""
...
async def test_final_trade():
    print("🚀 FINAL TRADE TEST - BASE MAINNET")
    print("=" * 60)
    print("⚠️  This will execute REAL transactions on Base mainnet")
    print("   Using Avantis SDK build_trade_open_tx method")
    print("=" * 60)
    ...
    try:
        ...
        # Try to build a trade transaction
        ...
        try:
            ...
            trade_input = TradeInput(
                ...
                open_collateral=10 * 10**6,  # 10 USDC in wei (back to 10)
...
if __name__ == "__main__":
    success = asyncio.run(test_final_trade())
    if success:
        print("\n🎉 FINAL TRADE TEST PASSED!")
