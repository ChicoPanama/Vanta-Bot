...
async def practical_debug_test():
    ...
    try:
        ...
        if eth_balance_ether < 0.001:
            print(f'   ❌ Insufficient ETH for gas (need > 0.001 ETH)')
            return False
        else:
        ...
        if usdc_balance < 100:
            print(f'   ❌ Insufficient USDC (need > 100 USDC)')
            return False
        else:
            print(f'   ✅ Sufficient USDC')
        ...
        print(f'   Testing ETH/USD (Pair 0)...')
        try:
            ...
            print(f'   ✅ TradeInput created for ETH/USD')
            ...
            print(f'   ✅ ETH transaction built successfully!')
            print(f'   📝 Transaction: {trade_tx}')
            
            # Try to execute
            print(f'   🔄 Executing ETH trade...')
            tx_hash = await trader.send_and_get_transaction_hash(trade_tx)
            print(f'   ✅ ETH trade executed successfully!')
            ...
            print(f'   Testing BTC/USD (Pair 1)...')
            try:
                ...
                print(f'   ✅ TradeInput created for BTC/USD')
                ...
                print(f'   ✅ BTC transaction built successfully!')
                
                tx_hash_btc = await trader.send_and_get_transaction_hash(trade_tx_btc)
                print(f'   ✅ BTC trade executed successfully!')
                ...
                print(f'   Testing with higher collateral ($500)...')
                try:
                    ...
                    print(f'   ✅ $500 transaction built successfully!')
                    
                    tx_hash_high = await trader.send_and_get_transaction_hash(trade_tx_high)
                    print(f'   ✅ $500 trade executed successfully!')
                    ...
                    print(f'   → This confirms the minimum is much higher than $500')
                    print(f'   → Need to find actual working parameters from BaseScan')
