...
async def test_minimum_requirement():
    ...
    try:
        ...
        print("   Side: LONG")
        print("   Leverage: 10x")
        print("   Size: $10 USDC (minimum requirement)")
        ...
        try:
            ...
            print("✅ TradeInput created with minimum $10:")
            ...
            if hasattr(trade_error, "args") and len(trade_error.args) > 0:
                ...
                if "BELOW_MIN_POS" in error_msg:
                    ...
                    print("→ Current position: $100 (10 × 10x leverage)")
                    print("→ This suggests minimum is higher than $100")
                else:
