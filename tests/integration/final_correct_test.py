...
async def final_correct_test():
    ...
    try:
        ...
        print("   Side: LONG")
        print("   Leverage: 10x (reasonable)")
        print("   Collateral: $10 USDC (minimum requirement)")
        print("   Position Size: $100 (10 × 10x leverage)")
        print("   This should work according to Avantis docs")
        ...
        try:
            ...
            if "BELOW_MIN_POS" in str(trade_error):
                print("→ BELOW_MIN_POS error still occurs")
                print("→ This suggests the minimum is higher than $10")
                print("→ Or there are other parameter issues")
                ...
                try:
                    ...
                    print("✅ $50 transaction built successfully!")
                    tx_hash_50 = await trader.send_and_get_transaction_hash(trade_tx_50)
                    print("✅ $50 trade executed successfully!")
                    ...
                    print("→ This confirms the minimum is much higher than $50")
                    print("→ Likely $1000+ minimum position size required")
