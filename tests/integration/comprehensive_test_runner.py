...
class ComprehensiveBotTester:
    ...
    def setup_mocks(self):
        ...
        self.execution_patcher = patch('src.services.trading.execution_service.get_execution_service')
    ...
    def _setup_common_mocks(self):
        ...
        self.mock_wallet_manager.get_balance.return_value = {'ETH': '1.0', 'USDC': '1000.0'}
        ...
        # Mock Avantis client
        self.mock_avantis_client.get_balance.return_value = {'ETH': '1.0', 'USDC': '1000.0'}
    ...
    async def run_comprehensive_tests(self):
        ...
        try:
            ...
            print("\n📋 Section 1: Initialization & Core Commands")
            self._add_result(await self._run_test("1.1", self.test_1_1_first_time_user_start))
            ...
            print("\n📊 Section 4: Trading Flows")
            self._add_result(await self._run_test("4.1", self.test_4_1_standard_trade_flow))
            
            # Section 5: Position & Portfolio Management
            print("\n📈 Section 5: Position & Portfolio Management")
            self._add_result(await self._run_test("5.1", self.test_5_1_view_positions))
            self._add_result(await self._run_test("5.3", self.test_5_3_portfolio_analytics))
            ...
            self._add_result(await self._run_test("8.1", self.test_8_1_user_preferences))
