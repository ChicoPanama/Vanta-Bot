...
from src.services.oracle import OracleFacade, create_price_validator, PriceQuote
...
class TestOracleFacadeIntegration:
    ...
    async def mock_pyth_oracle(self):
        ...
        oracle.get_price = AsyncMock(return_value=PriceQuote(
    ...
    @pytest.mark.asyncio
    async def test_dual_feed_deviation_gating(self, mock_pyth_oracle, mock_chainlink_oracle):
    ...
    @pytest.mark.asyncio
    async def test_secondary_fallback_on_primary_failure(self, mock_pyth_oracle, mock_chainlink_oracle):
    ...
    @pytest.mark.asyncio
    async def test_high_deviation_rejection(self, mock_pyth_oracle, mock_chainlink_oracle):
