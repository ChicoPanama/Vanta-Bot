...
from src.copy_trading.copy_executor import CopyConfiguration, CopyExecutor, CopyStatus
...
@pytest.fixture
def copy_executor(
    mock_db_pool, mock_redis, mock_avantis_client, mock_market_intelligence, mock_config
):
...
async def test_follow_trader_invalid_config(copy_executor):
    ...
    user_id = 123
    leader_address = "0xabc123"
    config = {"sizing_mode": "INVALID_MODE", "sizing_value": 100.0}
