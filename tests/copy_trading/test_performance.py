...
pytestmark = pytest.mark.skipif(
    not os.getenv("RUN_SLOW"), reason="slow suite; set RUN_SLOW=1 to enable"
)
...
class TestPerformance:
    ...
    async def test_error_recovery_performance(self):
        ...
        # Test error recovery
        tasks = [service.get_top_traders(limit=10) for _ in range(100)]
    ...
    async def test_scalability_limits(self):
        ...
        for concurrent_requests in [10, 50, 100, 200]:
            ...
            tasks = [
                service.get_top_traders(limit=10) for _ in range(concurrent_requests)
            ]
