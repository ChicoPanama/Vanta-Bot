    ...
    try:
        ...
        try:
            ...
            if hasattr(trader.feed_client, 'get_update_data_for_pair'):
                ...
                print(f'   ❌ get_update_data_for_pair not found')
        except Exception as e:
        ...
        try:
            ...
            if hasattr(trader.feed_client, 'get_price'):
                ...
                if hasattr(trader.feed_client, 'construct_update_data'):
                    update_data = await trader.feed_client.construct_update_data([eth_price])
                    print(f'   ✅ Constructed update data: {update_data}')
                else:
                    print(f'   ❌ construct_update_data not found')
            else:
                print(f'   ❌ get_price not found')
        except Exception as e:
