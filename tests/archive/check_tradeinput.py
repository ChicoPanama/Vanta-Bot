...
async def check_tradeinput_structure():
    ...
    try:
        ...
        try:
            ...
            print(f'   ✅ Method 1 (pair_index) worked!')
            ...
            try:
                ...
                print(f'   ✅ Method 2 (no pair_index) worked!')
                print(f'   TradeInput: {trade_input}')
                ...
                try:
                    ...
                    print(f'   ✅ Method 3 (minimal) worked!')
                    print(f'   TradeInput: {trade_input}')
                    ...
                    required_fields = [field for field, info in TradeInput.__fields__.items() if info.is_required()]
                    print(f'   Required fields: {required_fields}')
                    
                    # Create with only required fields
                    trade_input = TradeInput(
                        **{field: 0 for field in required_fields}
                    )
                    print(f'   ✅ Method 4 (required only) worked!')
                    print(f'   TradeInput: {trade_input}')
        
        print(f'\n✅ STRUCTURE CHECK COMPLETE!')
        print(f'✅ Now we know the correct TradeInput structure')
