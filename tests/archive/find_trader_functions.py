...
async def find_trader_functions():
    ...
    try:
        ...
        print(f'✅ Trading contract ABI loaded')
        ...
        for item in abi:
            if item.get('type') == 'function':
                ...
                if any(keyword in name.lower() for keyword in ['order', 'open', 'submit', 'create', 'initiate']):
        ...
        if 'openTrade' in [f[0] for f in trader_functions]:
            ...
            try:
                ...
                if open_trade_func:
                    ...
                    print(f'   🔄 Testing openTrade call...')
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(f'✅ openTrade is the correct trader function')
                    ...
                    print(f'   ❌ openTrade function not found in ABI')
                    return False
