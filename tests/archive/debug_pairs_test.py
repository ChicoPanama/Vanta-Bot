    ...
    try:
        ...
        try:
            ...
            test_cases = [
                {
                    "collateral": 10 * 10**6,
                    "leverage": 2,
                    "desc": "10 USDC, 2x leverage",
                },
                {
                    "collateral": 50 * 10**6,
                    "leverage": 10,
                    "desc": "50 USDC, 10x leverage",
                },
                {
                    "collateral": 100 * 10**6,
                    "leverage": 50,
                    "desc": "100 USDC, 50x leverage",
                },
                {
                    "collateral": 1000 * 10**6,
                    "leverage": 10,
                    "desc": "1000 USDC, 10x leverage",
                },
            ]
            ...
            for i, test_case in enumerate(test_cases):
                ...
                print(
                    f"    Position size: {test_case['collateral'] * test_case['leverage'] / 10**6} USDC"
                )
                ...
                try:
                    await trader.trade.build_trade_open_tx(
