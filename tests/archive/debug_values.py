...
async def debug_actual_values():
    ...
    try:
        ...
        for i, test_case in enumerate(test_cases):
            ...
            print(
                f"   Expected position: {test_case['expected_position'] / 10**6} USDC"
            )
            ...
            try:
                ...
                if "BELOW_MIN_POS" in str(e):
                    ...
                    print(
                        f"   → Current position: {test_case['expected_position'] / 10**6} USDC"
                    )
                    print(
                        f"   → This suggests minimum is higher than {test_case['expected_position'] / 10**6} USDC"
                    )
                else:
        ...
        print(
            "This suggests the Avantis protocol has extremely high minimum position requirements"
        )
