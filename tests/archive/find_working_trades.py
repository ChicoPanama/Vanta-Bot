    ...
    try:
        ...
        try:
            ...
            if trade_events:
                ...
                print(
                    f"   BaseScan: https://basescan.org/tx/{recent_event.transactionHash.hex()}"
                )
                ...
                try:
                    ...
                    if all_logs:
                        ...
                        print(
                            f"   BaseScan: https://basescan.org/tx/{recent_log.transactionHash.hex()}"
                        )
