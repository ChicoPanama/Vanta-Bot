    ...
    try:
        ...
        test_configs = [
            (
                ...
                1000,
                4000,
            ),  # $100 collateral, 10x leverage, $1000 position, $4000 price
            (
                500,
                10,
                5000,
                4000,
            ),  # $500 collateral, 10x leverage, $5000 position, $4000 price
            (
                1000,
                10,
                10000,
                4000,
            ),  # $1000 collateral, 10x leverage, $10000 position, $4000 price
            (
                100,
                100,
                10000,
                4000,
            ),  # $100 collateral, 100x leverage, $10000 position, $4000 price
            (
                1000,
                100,
                100000,
                4000,
            ),  # $1000 collateral, 100x leverage, $100000 position, $4000 price
        ]
        ...
        print("❌ Even with explicit positionSizeUSDC and openPrice failed")
