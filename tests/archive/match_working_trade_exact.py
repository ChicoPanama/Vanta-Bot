...
async def match_working_trade_exact():
    ...
    try:
        ...
        try:
            ...
            print(f'   📊 Trade struct with EXACT working parameters:')
            ...
            print(f'   ✅ openTrade call successful!')
            ...
            try:
                ...
                print(f'   📊 Trade struct with HIGH values:')
                ...
                print(f'   ✅ HIGH openTrade call successful!')
