...
async def correct_open_trade():
    ...
    try:
        ...
        test_configs = [
            (100000000, 1000000000, 10),      # $100 collateral, $1000 position, 10x leverage
            (500000000, 5000000000, 10),      # $500 collateral, $5000 position, 10x leverage
            (1000000000, 10000000000, 10),    # $1000 collateral, $10000 position, 10x leverage
            (100000000, 10000000000, 100),    # $100 collateral, $10000 position, 100x leverage
            (1000000000, 100000000000, 100),  # $1000 collateral, $100000 position, 100x leverage
        ]
        ...
        print(f'❌ Even with $100,000 position size failed')
