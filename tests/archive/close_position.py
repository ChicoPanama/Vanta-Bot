...
def close_position():
    ...
    try:
        ...
        logger.info(f"Building close transaction...")
        ...
        logger.info(f"✅ CLOSE TRANSACTION SUBMITTED")
        ...
        if receipt.status == 1:
            ...
            logger.info(f"Results saved to: close_position_success.json")
            logger.info(f"💰 Funds should now be returned to your wallet!")
        ...
        logger.info(f"Error details saved to: close_position_error.json")
