...
def check_avantis_compatibility():
    ...
    keyboard_files = [
        (
            ...
            "Enhanced keyboards with Avantis compatibility",
        ),
    ]
    ...
    avantis_features = [
        (
            ...
            "Enhanced Avantis client with SDK methods",
        ),
    ]
    ...
    bot_files = [
        ...
        (
            "src/bot/handlers/start_updated.py",
            "Updated start handler with user selection",
        ),
    ]
