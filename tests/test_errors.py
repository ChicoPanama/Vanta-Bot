...
class TestAppError:
    ...
    def test_app_error_to_dict(self):
        ...
        error = AppError(
            "Test error", error_code="TEST_ERROR", details={"field": "value"}
        )
...
class TestSpecificErrors:
    ...
    def test_blockchain_error(self):
        ...
        error = BlockchainError("Transaction failed", network="base", tx_hash="0x123")
    ...
    def test_trading_error(self):
        """Test TradingError"""
        error = TradingError("Trade failed", pair="ETH/USD", side="long", amount=100.0)
    ...
    def test_copy_trading_error(self):
        ...
        error = CopyTradingError(
            "Copy trade failed", leader_address="0x123", follower_id=456, pair="BTC/USD"
        )
    ...
    def test_telegram_error(self):
        """Test TelegramError"""
        error = TelegramError("Telegram API error", user_id=123, command="/start")
    ...
    def test_rate_limit_error(self):
        ...
        error = RateLimitError(
            "Rate limit exceeded", limit=10, window="1 minute", user_id=123
        )
...
class TestTradingSpecificErrors:
    ...
    def test_insufficient_funds_error(self):
        ...
        error = InsufficientFundsError(
            "Insufficient funds", pair="ETH/USD", required=100.0, available=50.0
        )
    ...
    def test_invalid_position_error(self):
        ...
        error = InvalidPositionError(
            "Invalid position size", pair="BTC/USD", size=-100.0
        )
    ...
    def test_market_closed_error(self):
        ...
        error = MarketClosedError("Market is closed", pair="EUR/USD")
    ...
    def test_slippage_exceeded_error(self):
        ...
        error = SlippageExceededError(
            "Slippage too high", pair="ETH/USD", slippage=5.0, max_slippage=2.0
        )
...
class TestCopyTradingSpecificErrors:
    ...
    def test_leader_not_found_error(self):
        ...
        error = LeaderNotFoundError("Leader not found", leader_address="0x123")
    ...
    def test_leader_inactive_error(self):
        ...
        error = LeaderInactiveError(
            "Leader is inactive", leader_address="0x123", last_activity=1234567890
        )
    ...
    def test_copy_limit_exceeded_error(self):
        ...
        error = CopyLimitExceededError(
            "Copy limit exceeded", leader_address="0x123", current_count=10, max_count=5
        )
