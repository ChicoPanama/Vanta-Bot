...
def upgrade():
    ...
    op.create_table('wallets',
        ...
        sa.Column('encryption_version', sa.String(length=16), nullable=False, server_default='v2'),
    ...
    op.create_index('ix_sent_transactions_request_id', 'sent_transactions', ['request_id'])
    op.create_index('ix_sent_transactions_tx_hash', 'sent_transactions', ['tx_hash'])
    op.create_index('ix_sent_transactions_wallet_id', 'sent_transactions', ['wallet_id'])
    op.create_unique_constraint('uq_sent_transactions_request_id', 'sent_transactions', ['request_id'])
    
    # Add precision columns to existing tables
    op.add_column('fills', sa.Column('size_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('fills', sa.Column('price_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('fills', sa.Column('notional_usd_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('fills', sa.Column('fee_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    
    op.add_column('trading_positions', sa.Column('entry_px_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('trading_positions', sa.Column('size_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('trading_positions', sa.Column('pnl_realized_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('trading_positions', sa.Column('fees_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('trading_positions', sa.Column('funding_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    
    op.add_column('copy_configurations', sa.Column('sizing_value_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('copy_configurations', sa.Column('max_leverage_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('copy_configurations', sa.Column('notional_cap_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    
    op.add_column('copy_positions', sa.Column('size_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('copy_positions', sa.Column('entry_price_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('copy_positions', sa.Column('copy_ratio_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    op.add_column('copy_positions', sa.Column('pnl_precise', sa.Numeric(precision=38, scale=18), nullable=True))
    ...
    op.create_index('idx_trading_positions_address_opened', 'trading_positions', ['address', 'opened_at'])
    op.create_index('idx_trading_positions_address_closed', 'trading_positions', ['address', 'closed_at'])
