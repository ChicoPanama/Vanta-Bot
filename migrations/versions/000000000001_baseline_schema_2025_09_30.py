...
def upgrade():
    ...
    op.create_index(
        op.f("ix_copy_configurations_created_at"),
        "copy_configurations",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_configurations_leader_address"),
        "copy_configurations",
        ["leader_address"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_configurations_updated_at"),
        "copy_configurations",
        ["updated_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_configurations_user_id"),
        "copy_configurations",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_copy_positions_user_status",
        "copy_positions",
        ["user_id", "status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_positions_copy_tx_hash"),
        "copy_positions",
        ["copy_tx_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_positions_leader_address"),
        "copy_positions",
        ["leader_address"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_positions_leader_tx_hash"),
        "copy_positions",
        ["leader_tx_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_positions_opened_at"),
        "copy_positions",
        ["opened_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_copy_positions_user_id"), "copy_positions", ["user_id"], unique=False
    )
    op.create_table(
        "fills",
        sa.Column("id", sa.BigInteger(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "idx_fills_address_pair_ts", "fills", ["address", "pair", "ts"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_fills_block_number"), "fills", ["block_number"], unique=False
    )
    ...
    op.create_index(
        "ix_ifills_user_sym_block",
        "indexed_fills",
        ["user_address", "symbol", "block_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_indexed_fills_block_number"),
        "indexed_fills",
        ["block_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_indexed_fills_symbol"), "indexed_fills", ["symbol"], unique=False
    )
    op.create_index(
        op.f("ix_indexed_fills_tx_hash"), "indexed_fills", ["tx_hash"], unique=False
    )
    op.create_index(
        op.f("ix_indexed_fills_user_address"),
        "indexed_fills",
        ["user_address"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_sent_transactions_request_id"),
        "sent_transactions",
        ["request_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_sent_transactions_tx_hash"),
        "sent_transactions",
        ["tx_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_sent_transactions_wallet_id"),
        "sent_transactions",
        ["wallet_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_trading_positions_address"),
        "trading_positions",
        ["address"],
        unique=False,
    )
    op.create_index(
        op.f("ix_trading_positions_opened_at"),
        "trading_positions",
        ["opened_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_trading_positions_pair"), "trading_positions", ["pair"], unique=False
    )
    op.create_table(
        "transactions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_tx_intents_intent_key"), "tx_intents", ["intent_key"], unique=True
    )
    op.create_index(
        "ix_txintent_status_created",
        "tx_intents",
        ["status", "created_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tx_receipts_tx_hash"), "tx_receipts", ["tx_hash"], unique=True
    )
    op.create_table(
        "user_positions",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        "ix_user_pos_user_symbol",
        "user_positions",
        ["user_address", "symbol"],
        unique=True,
    )
    op.create_index(
        op.f("ix_user_positions_symbol"), "user_positions", ["symbol"], unique=False
    )
    op.create_index(
        op.f("ix_user_positions_user_address"),
        "user_positions",
        ["user_address"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tx_sends_intent_id"), "tx_sends", ["intent_id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_trading_positions_opened_at"), table_name="trading_positions"
    )
    op.drop_index(op.f("ix_trading_positions_address"), table_name="trading_positions")
    op.drop_index(
        "idx_trading_positions_address_opened", table_name="trading_positions"
    )
    op.drop_index(
        "idx_trading_positions_address_closed", table_name="trading_positions"
    )
    op.drop_table("trading_positions")
    op.drop_table("sync_state")
    op.drop_index(
        op.f("ix_sent_transactions_wallet_id"), table_name="sent_transactions"
    )
    op.drop_index(op.f("ix_sent_transactions_tx_hash"), table_name="sent_transactions")
    op.drop_index(
        op.f("ix_sent_transactions_request_id"), table_name="sent_transactions"
    )
    ...
    op.drop_index(
        op.f("ix_copy_configurations_user_id"), table_name="copy_configurations"
    )
    op.drop_index(
        op.f("ix_copy_configurations_updated_at"), table_name="copy_configurations"
    )
    op.drop_index(
        op.f("ix_copy_configurations_leader_address"), table_name="copy_configurations"
    )
    op.drop_index(
        op.f("ix_copy_configurations_created_at"), table_name="copy_configurations"
    )
