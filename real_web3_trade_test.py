...
async def test_real_web3_trade():
    ...
    try:
        ...
        print(f'   Side: LONG')
        print(f'   Leverage: 50x (increased for larger position size)')
        print(f'   Size: $10')
        ...
        try:
            ...
            for func_name in dir(contract.functions):
                if not func_name.startswith('_') and ('open' in func_name.lower() or 'trade' in func_name.lower()):
                    print(f'  - {func_name}')
            ...
            try:
                ...
                if open_trade_func:
                    ...
                    try:
                        ...
                        tx = open_trade_func().build_transaction({
