...
async def test_large_position():
    ...
    try:
        ...
        print(f'   Side: LONG')
        print(f'   Leverage: 100x (maximum leverage)')
        print(f'   Size: $100 USDC')
        print(f'   Position Size: $10,000 (100 × 100x leverage)')
        ...
        try:
            ...
            print(f'✅ TradeInput created with $100 USDC, 100x leverage = $10,000 position')
